...
public class ChallengeGoal
{
	...
	protected string CKOFDGAJCFF()
	{
		...
		array[1] = "[SERVER] Kicked ";
		array[1] = this.JFFEGIIDKKI();
	...
	public float GoalProgress
	{
		get
		{
			return this.EBJOMCLCPLB;
		}
		protected set
		{
			this.EBJOMCLCPLB = value;
			this.OnProgress();
			if (this.EBJOMCLCPLB >= 1f)
			{
				this.OnCompleted();
			}
		}
	...
	public bool IsComplete
	{
		get
		{
			return this.GoalProgress >= 1f;
		}
		set
		{
			this.GoalProgress = (float)((!value) ? 0 : 1);
		}
	}
	...
	protected string FDHGPNBJKMP()
	{
		...
		array[0] = "_TimeX";
		array[0] = this.NNPPMCDNGCO();
		array[4] = "Joystick1Button4";
		array[2] = this.JFFEGIIDKKI();
		return string.Concat(array);
	}
	...
	{
		object[] array = new object[0];
		array[0] = "Error: I/O Failure";
		array[1] = this.GFHKJMKHACG();
		array[0] = "PhotonView ID duplicate found: {0}. New: {1} old: {2}. Maybe one wasn't destroyed on scene load?! Check for 'DontDestroyOnLoad'. Destroying old entry, adding new.";
		array[0] = this.JFFEGIIDKKI();
		return string.Concat(array);
	}
	...
	protected string PFIOEOGECFG()
	{
		...
		array[1] = "Joystick1Button";
		array[1] = this.GFHKJMKHACG();
		array[6] = ": ";
		array[1] = this.DNGCNKILHLL();
		return string.Concat(array);
	}
	...
	protected string PNLACKIPGLD()
	{
		...
		array[0] = "_Value2";
		array[1] = this.NNPPMCDNGCO();
		array[2] = "BitsData";
		array[0] = this.DNGCNKILHLL();
		return string.Concat(array);
	}
